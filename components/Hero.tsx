    ...
    <header className="relative pt-32 pb-32 px-4 text-center overflow-hidden bg-wood-900 bg-wood-texture text-cream mt-10">
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <a 
          ...
          className="inline-flex items-center gap-3 bg-sage-500 hover:bg-sage-400 text-wood-900 text-lg px-8 py-4 rounded-full font-bold shadow-[0_4px_0_0_#3d5240] hover:shadow-[0_2px_0_0_#3d5240] hover:translate-y-[2px] transition-all border-2 border-sage-600 group"
        >
          ORDINA SU WHATSAPP 
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 transition-transform group-hover:scale-110">
